from ..commons import *
from ..shapes import RegularConvexPolygonShape, RectEditBox
from ..settings import config

class RegularConvexPolygonCreator(object):
    def __init__(self, point):
        self.shape = RegularConvexPolygonShape(Point(0, 0), Color(0,0,0,1),
                        config.DEFAULT_BORDER_WIDTH, Color(1,1,1,0), 1, 1, 6)
        self.edit_boxes = []
